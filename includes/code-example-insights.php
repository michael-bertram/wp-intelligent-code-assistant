...
function intelligent_code_assistant_render_code_example_insights_detail( $id ) {
	...
	<div class="wrap ica-insights-workspace ica-code-example-insights ica-insights-detail">
		<header class="ica-page-header ica-page-header--detail"><nav class="ica-back-nav"><a href="<?php echo esc_url( $back ); ?>">&larr; <?php esc_html_e( 'Back to Code Snippet Insights', 'intelligent-code-assistant' ); ?></a></nav><div class="ica-header-title"><h1><?php echo esc_html( get_the_title( $id ) ?: sprintf( __( 'Code Snippet #%d', 'intelligent-code-assistant' ), $id ) ); ?></h1></div><div class="ica-header-summary"><p class="description"><?php printf( esc_html__( '%1$d recorded interactions across %2$d article(s). These are actions, not unique readers.', 'intelligent-code-assistant' ), (int) $s['totalInteractions'], count( $s['articles'] ) ); ?></p></div></header>
