...
function intelligent_code_assistant_render_code_example_insights_detail( $id ) {
	...
	<div class="wrap ica-insights-workspace ica-code-example-insights ica-insights-detail">
		<header class="ica-page-header"><nav class="ica-back-nav"><a href="<?php echo esc_url( $back ); ?>">&larr; <?php esc_html_e( 'Back to Code Snippet Insights', 'intelligent-code-assistant' ); ?></a></nav><h1><?php echo esc_html( get_the_title( $id ) ?: sprintf( __( 'Code Snippet #%d', 'intelligent-code-assistant' ), $id ) ); ?></h1><p class="description"><?php printf( esc_html__( '%1$d recorded interactions across %2$d article(s). These are actions, not unique readers.', 'intelligent-code-assistant' ), (int) $s['totalInteractions'], count( $s['articles'] ) ); ?></p></header>
