...
add_action( 'admin_enqueue_scripts', function ( $hook_suffix ) {
	...
	wp_localize_script( 'intelligent-code-assistant-reader-insights-admin', 'ICAReaderInsights', array(
		'mode' => $code_example_id ? 'codeExample' : 'article',
		'codeExampleId' => $code_example_id,
		'endpoint' => $code_example_id ? rest_url( 'intelligent-code-assistant/v1/analyze-code-example-insights' ) : '',
		...
		'i18n' => array(
			...
			'generated' => __( 'Generated from current Code Example analytics', 'intelligent-code-assistant' ),
			'error' => __( 'AI insights are currently unavailable. Please try again later.', 'intelligent-code-assistant' ),
			'intro' => __( 'Interpret the deterministic analytics for this Code Example across every article where it appears. Suggestions are evidence-based and remain for the author to review.', 'intelligent-code-assistant' ),
